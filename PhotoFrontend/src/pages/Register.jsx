        ...
        >
            ...
            <main className="w-full max-w-md px-6 py-12 relative z-10">
                ...
                <div className="mb-10 text-center">
                    <h1 className="text-primary font-headline font-black text-4xl tracking-tighter uppercase mb-2">PixelLyra.com</h1>
            ...
            <footer className="fixed bottom-6 w-full text-center pointer-events-none z-10">
                <span className="text-[10px] font-bold uppercase tracking-widest text-slate-700">PixelLyra.com System v2.4.0 • Encrypted Connection</span>
            </footer>
        </div>
    );
};
